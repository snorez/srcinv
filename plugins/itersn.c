...
{
	fprintf(stdout, "\t[output_path]\tTraversal all sinodes to stderr/file\n");
}

static long itersn_cb(int argc, char *argv[])
{
	if ((argc > 2) || (argc <= 0)) {
